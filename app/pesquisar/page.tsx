            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              {(searchTerm || selectedCategory !== "todas") && (
                <Button
                  ...
                  className="w-full sm:w-auto text-muted-foreground hover:text-foreground hover:bg-muted/50 border border-border/50 hover:border-border transition-all duration-200"
                >
            ...
            {filteredScales.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <Button
                  onClick={clearFilters}
                  variant="ghost"
                  className="text-muted-foreground hover:text-foreground hover:bg-muted/50 border border-border/50 hover:border-border transition-all duration-200"
                >
                  Limpar Filtros
                </Button>
              </div>
