        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8 md:mb-16 animate-fade-in">
            <div className="flex justify-center mb-4 md:mb-6">
              <div className="p-3 md:p-6 bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl border-2 border-red-200">
                <Heart className="h-6 w-6 md:h-12 md:w-12 text-red-600" />
              </div>
            </div>
            <h1 className="text-xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-6 px-2">Escalas de Avaliação da Dor</h1>
                  ...
                  <CardHeader className="pb-2 md:pb-6">
                    <div className="flex items-start gap-2">
                      <div className="p-1.5 md:p-3 bg-white/80 rounded-xl shrink-0 group-hover:scale-110 transition-transform duration-300">
                        <scale.icon className="h-4 w-4 md:h-6 md:w-6 text-red-600" />
                      </div>
                      <div className="flex-1 min-w-0">
          ...
          <div className="text-center animate-slide-up px-2">
            <Card className="max-w-5xl mx-auto bg-gradient-to-br from-primary/5 to-accent/5 border-2 border-primary/10">
              <CardContent className="pt-6 pb-6 md:pt-12 md:pb-12">
                <h3 className="text-lg md:text-3xl font-bold mb-3 md:mb-6">Importância Clínica da Avaliação da Dor</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                  <div className="text-center">
                    <div className="w-12 h-12 md:w-20 md:h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-2 md:mb-4">
                      <Heart className="h-6 w-6 md:h-10 md:w-10 text-primary" />
                    </div>
                    <h4 className="font-semibold text-sm md:text-lg mb-1 md:mb-2">Cuidado Humanizado</h4>
                    <p className="text-muted-foreground text-xs md:text-sm">Reconhecimento e alívio do sofrimento</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 md:w-20 md:h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-2 md:mb-4">
                      <Users className="h-6 w-6 md:h-10 md:w-10 text-primary" />
                    </div>
                    <h4 className="font-semibold text-sm md:text-lg mb-1 md:mb-2">Comunicação Efetiva</h4>
                    <p className="text-muted-foreground text-xs md:text-sm">Linguagem comum entre profissionais</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 md:w-20 md:h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-2 md:mb-4">
                      <Stethoscope className="h-6 w-6 md:h-10 md:w-10 text-primary" />
                    </div>
                    <h4 className="font-semibold text-sm md:text-lg mb-1 md:mb-2">Qualidade Assistencial</h4>
                    <p className="text-muted-foreground text-xs md:text-sm">Intervenções baseadas em evidências</p>
                  </div>
                </div>
              </CardContent>
            </Card>
