...
import { Brain, BookOpen, FileText, Users, ArrowLeft } from "lucide-react"
      ...
      <div className="container mx-auto px-3 md:px-4 py-4 md:py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-4 md:mb-6">
            <Link href="/categorias/avaliacao-neurologica">
              <Button
                variant="outline"
                className="flex items-center gap-1 md:gap-2 hover:bg-nursing-sage/10 bg-transparent text-xs md:text-sm h-8 md:h-10"
              >
          ...
          <div className="text-center mb-6 md:mb-8">
            <Badge
              variant="secondary"
              className="mb-2 md:mb-4 bg-nursing-sage/20 text-nursing-sage border-nursing-sage/30 text-xs"
            >
              Avaliação Neurológica
            </Badge>
            <h1 className="text-xl md:text-2xl lg:text-4xl font-bold text-nursing-forest mb-2 md:mb-4 text-balance px-2">
              Escala de Coma de Glasgow
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-nursing-sage leading-relaxed max-w-3xl mx-auto px-4">
          ...
          {/* Finalidade */}
          <Card className="mb-4 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5 pb-2 md:pb-6">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-sm md:text-base lg:text-lg">
                <Brain className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
                Finalidade e Objetivo
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed text-xs md:text-sm lg:text-base">
          ...
          <Card className="mb-4 md:mb-8 border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-3 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed mb-4 md:mb-6 text-xs md:text-sm lg:text-base">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  ...
                  <p className="text-nursing-charcoal mb-2 text-xs md:text-sm">
                    Avalia a capacidade de abertura espontânea ou estimulada dos olhos:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-2 md:ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  ...
                  <p className="text-nursing-charcoal mb-2 text-xs md:text-sm">
                    Avalia a capacidade de comunicação verbal e orientação:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-2 md:ml-4 text-xs md:text-sm">
                    <li>
                  ...
                  <p className="text-nursing-charcoal text-xs mt-2 italic">
            ...
            <CardContent className="p-3 md:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                <div className="bg-red-50 border border-red-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 mb-2 text-sm md:text-base">Coma Grave (3-8 pontos)</h4>
                ...
                <div className="bg-green-50 border border-green-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-green-800 mb-2 text-sm md:text-base">Coma Leve (13-15 pontos)</h4>
                ...
                <div className="bg-blue-50 border border-blue-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-800 mb-2 text-sm md:text-base">Considerações Especiais</h4>
          ...
          <Card className="mb-4 md:mb-8 border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-3 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed mb-4 text-xs md:text-sm lg:text-base">
          ...
          <Card className="mb-4 md:mb-8 border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-3 md:p-6">
              <div className="bg-gray-50 p-3 md:p-4 rounded-lg border-l-4 border-nursing-sage">
                <p className="text-nursing-charcoal leading-relaxed mb-3 md:mb-4 text-xs md:text-sm">
          ...
          <Card className="border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-3 md:p-6">
              <ul className="space-y-2 md:space-y-3 text-nursing-charcoal text-xs md:text-sm">
