      ...
      <main className="flex-1 py-4 md:py-8">
        <div className="container mx-auto px-3 md:px-4 max-w-4xl">
          ...
          <div className="text-center mb-6 md:mb-8">
            ...
            <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 px-2">Escala Numérica de Dor</h1>
          ...
          <Card className="mb-4 md:mb-8">
            ...
            <CardContent>
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">Cuidados Durante a Aplicação:</h3>
              ...
              <div className="bg-muted/30 p-6 rounded-lg">
                ...
                <div className="space-y-4 text-sm md:text-base">
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    ...
                    <p className="mb-2 text-sm md:text-base">
                      Reaplicada END após 1h45min da administração da medicação anti-inflamatória.
                    </p>
                    <p className="mb-2 text-sm md:text-base">
                  ...
                  <div className="border-l-4 border-orange-500 pl-4">
                    ...
                    <p className="mb-2 text-sm md:text-base">Nova avaliação conforme protocolo institucional (6/6h).</p>
                    <p className="mb-2 text-sm md:text-base">
          ...
          <Card className="mb-4 md:mb-8">
            ...
            <CardContent>
              <div className="space-y-4 md:space-y-6">
                <div>
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">Normas e Diretrizes Oficiais:</h3>
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 text-xs md:text-sm">
                ...
                <div>
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">Literatura Científica:</h3>
