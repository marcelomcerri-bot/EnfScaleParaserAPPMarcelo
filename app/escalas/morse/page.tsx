      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          ...
          <div className="flex items-center mb-4">
            <Shield className="h-8 w-8 md:h-10 md:w-10 text-nursing-forest mr-3 md:mr-4" />
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-nursing-forest">Escala de Morse</h1>
              <p className="text-sm md:text-base text-nursing-forest/70">Morse Fall Scale (MFS)</p>
            </div>
          </div>

          <div className="flex flex-wrap gap-2 mb-4 md:mb-6">
            <Badge className="bg-nursing-forest text-white text-xs md:text-sm">Risco de Quedas</Badge>
            <Badge variant="outline" className="border-nursing-sage text-nursing-forest text-xs md:text-sm">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 md:space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 bg-white/50 border border-nursing-sage/20 h-auto">
            <TabsTrigger
              value="overview"
              className="data-[state=active]:bg-nursing-forest data-[state=active]:text-white text-xs md:text-sm p-2 md:p-3"
            >
              Visão Geral
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="overview" className="space-y-4 md:space-y-6">
            <Card className="border-nursing-sage/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-nursing-forest flex items-center text-lg md:text-xl">
                  <BookOpen className="mr-2 h-4 w-4 md:h-5 md:w-5" />
                  Finalidade e Objetivo
                </CardTitle>
              </CardHeader>
              <CardContent className="prose prose-sm md:prose-lg text-nursing-forest/80 max-w-none">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="bg-nursing-mint/20 p-4 rounded-lg">
                    ...
                    <p className="text-nursing-forest/80 text-sm md:text-base">
          ...
          <TabsContent value="application" className="space-y-4 md:space-y-6">
            <Card className="border-nursing-sage/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-nursing-forest flex items-center text-lg md:text-xl">
            ...
            <Card className="border-nursing-sage/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-nursing-forest text-lg md:text-xl">
                  Intervenções de Enfermagem por Nível de Risco
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50">
                    <h4 className="font-semibold text-yellow-800 mb-3 text-sm md:text-base">
                      Risco Moderado (25-50 pontos)
                    </h4>
                  ...
                  <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                    <h4 className="font-semibold text-red-800 mb-3 text-sm md:text-base">Alto Risco (≥51 pontos)</h4>
          ...
          <TabsContent value="example" className="space-y-4 md:space-y-6">
            <Card className="border-nursing-sage/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-nursing-forest flex items-center text-lg md:text-xl">
                  <FileText className="mr-2 h-4 w-4 md:h-5 md:w-5" />
          ...
          <TabsContent value="references" className="space-y-4 md:space-y-6">
            <Card className="border-nursing-sage/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-nursing-forest flex items-center text-lg md:text-xl">
                  <BookOpen className="mr-2 h-4 w-4 md:h-5 md:w-5" />
              ...
              <CardContent>
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-nursing-forest mb-3 text-sm md:text-base">
                      Referências Primárias
                    </h4>
                    <div className="space-y-3 text-nursing-forest/80 text-sm md:text-base">
                      <p>
                  ...
                  <div className="bg-nursing-mint/20 p-4 rounded-lg">
                    <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">Nota Importante</h4>
                    <p className="text-nursing-forest/80 text-sm md:text-base">
