...
import { MessageSquare, BookOpen, FileText, Users, ArrowLeft } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-4 md:mb-6">
            <Link href="/categorias/avaliacao-neurologica">
              <Button
                variant="outline"
                className="flex items-center gap-2 hover:bg-nursing-sage/10 bg-transparent text-xs md:text-sm h-8 md:h-10"
              >
          ...
          <div className="text-center mb-6 md:mb-8">
            <Badge
              variant="secondary"
              className="mb-3 md:mb-4 bg-nursing-sage/20 text-nursing-sage border-nursing-sage/30 text-xs"
            >
              Avaliação Neurológica - Sedação
            </Badge>
            <h1 className="text-2xl md:text-4xl font-bold text-nursing-forest mb-3 md:mb-4 text-balance px-2">
              Escala de Ramsay
            </h1>
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5 pb-3 md:pb-6">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-base md:text-lg">
                <MessageSquare className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-4 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed mb-4 md:mb-6 text-xs md:text-sm">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="bg-green-50 border border-green-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-green-800 mb-1 md:mb-2 text-sm md:text-base">
                    Nível 1 - Ansioso, Agitado ou Inquieto
                  </h4>
                  <p className="text-green-700 leading-relaxed text-xs md:text-sm">
                ...
                <div className="bg-blue-50 border border-blue-200 p-3 md:p-4 rounded-lg">
                  ...
                  <p className="text-blue-700 leading-relaxed text-xs md:text-sm">
                ...
                <div className="bg-yellow-50 border border-yellow-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-800 mb-1 md:mb-2 text-sm md:text-base">
                    Nível 3 - Responde Apenas a Comandos Verbais
                  </h4>
                ...
                <div className="bg-orange-50 border border-orange-200 p-3 md:p-4 rounded-lg">
                  ...
                  <p className="text-orange-700 leading-relaxed text-xs md:text-sm">
                ...
                <div className="bg-red-50 border border-red-200 p-3 md:p-4 rounded-lg">
                  ...
                  <p className="text-red-700 leading-relaxed text-xs md:text-sm">
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="bg-red-50 border border-red-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 mb-1 md:mb-2 text-sm md:text-base">
                    Sedação Inadequada (Níveis 1 e 6)
                  </h4>
