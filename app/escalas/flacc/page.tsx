      ...
      <main className="flex-1 py-4 md:py-8">
        <div className="container mx-auto px-3 md:px-4 max-w-4xl">
          ...
          <div className="text-center mb-6 md:mb-8">
            ...
            <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">Escala FLACC</h1>
            <div className="flex flex-col sm:flex-row justify-center gap-2 mb-3 md:mb-4">
              <Badge variant="secondary" className="bg-blue-50 text-blue-700 text-xs">
                Avaliação Comportamental da Dor
              </Badge>
              <Badge variant="outline" className="text-xs">
                Crianças de 2 meses a 7 anos
              </Badge>
            </div>
          </div>
            ...
            <CardContent className="pt-0">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="bg-muted/30 p-3 md:p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">F - FACE (Expressão Facial):</h3>
                ...
                <div className="bg-muted/30 p-3 md:p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">L - LEGS (Pernas):</h3>
                  <div className="space-y-2 text-xs md:text-sm">
                    <div className="flex items-start gap-2 md:gap-3">
                      <Badge variant="outline" className="shrink-0 text-xs">
                        0
                ...
                <div className="bg-muted/30 p-3 md:p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">A - ACTIVITY (Atividade):</h3>
                  <div className="space-y-2 text-xs md:text-sm">
                    <div className="flex items-start gap-2 md:gap-3">
                      <Badge variant="outline" className="shrink-0 text-xs">
                        0
                ...
                <div className="bg-muted/30 p-3 md:p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">C - CRY (Choro):</h3>
                  <div className="space-y-2 text-xs md:text-sm">
                    <div className="flex items-start gap-2 md:gap-3">
                      <Badge variant="outline" className="shrink-0 text-xs">
                        0
                ...
                <div className="bg-muted/30 p-3 md:p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 md:mb-3 text-sm md:text-base">
                    C - CONSOLABILITY (Consolabilidade):
                  </h3>
                  <div className="space-y-2 text-xs md:text-sm">
                    <div className="flex items-start gap-2 md:gap-3">
                      <Badge variant="outline" className="shrink-0 text-xs">
            ...
            <CardContent className="space-y-4 md:space-y-6 pt-0">
              <div>
                ...
                <p className="text-muted-foreground mb-3 md:mb-4 text-xs md:text-sm">
                  ...
                  comportamentos observados. A avaliação deve ser realizada através da observação direta da criança por
                  período de 1 a 5 minutos, registrando-se o comportamento predominante em cada categoria durante este
                  período.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-3 md:p-4 bg-green-50 rounded-lg border border-green-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-semibold text-green-800 text-sm md:text-base">0 - 3: Dor Leve ou Ausente</h4>
                    </div>
                  ...
                  <div className="p-3 md:p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <p className="text-xs md:text-sm text-yellow-700">
                      ...
                      parcial em suas atividades normais. Apresenta sinais comportamentais de dor que requerem atenção e
                      intervenção. Necessita de medidas analgésicas adequadas, técnicas de conforto e monitoramento mais
                      frequente para avaliar resposta às intervenções implementadas.
                    </p>
                  </div>
                  ...
                  <div className="p-3 md:p-4 bg-red-50 rounded-lg border border-red-200 md:col-span-2">
                    ...
                    <p className="text-xs md:text-sm text-red-700">
                      ...
                      Pontuações entre 8-10 indicam emergência álgica que demanda ação imediata e reavaliação frequente.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 text-xs md:text-sm">
                    <li>
              ...
              <div className="bg-muted/30 p-6 rounded-lg">
                ...
                <div className="space-y-4 text-sm md:text-base">
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    ...
                    <p className="mb-2 text-sm md:text-base">
                      Reaplicada Escala FLACC após 1h30min da medicação analgésica.
                    </p>
                  ...
                  <div className="border-l-4 border-orange-500 pl-4">
                    ...
                    <p className="mb-2 text-sm md:text-base">Avaliação noturna conforme protocolo pediátrico.</p>
                    <p className="mb-2 text-sm md:text-base">
