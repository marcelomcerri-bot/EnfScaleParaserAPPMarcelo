...
import { AlertTriangle, BookOpen, FileText, Users, ArrowLeft } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-4 md:mb-6">
            <Link href="/categorias/ulcera-pressao">
              <Button
                variant="outline"
                className="flex items-center gap-2 hover:bg-nursing-sage/10 bg-transparent text-xs md:text-base"
              >
                <ArrowLeft className="h-3 w-3 md:h-5 md:w-5 text-nursing-gold" />
                Voltar
              </Button>
            </Link>
          </div>
          ...
          <div className="text-center mb-6 md:mb-8">
            <Badge
              variant="secondary"
              className="mb-3 md:mb-4 bg-nursing-sage/20 text-nursing-sage border-nursing-sage/30 text-xs md:text-sm"
            >
              Risco de Úlcera por Pressão
            </Badge>
            <h1 className="text-2xl md:text-4xl font-bold text-nursing-forest mb-3 md:mb-4 text-balance">
              Escala de Norton
            </h1>
            <p className="text-sm md:text-lg text-nursing-sage leading-relaxed max-w-3xl mx-auto px-4">
          ...
          {/* Finalidade */}
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-lg md:text-xl">
                <AlertTriangle className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
                Finalidade e Objetivo
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed text-sm md:text-base">
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-lg md:text-xl">
                <BookOpen className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
                Descrição Completa da Escala
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed mb-4 md:mb-6 text-sm md:text-base">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">
                    1. Condição Física Geral
                  </h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia o estado geral de saúde e vitalidade do paciente:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">2. Estado Mental</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia o nível de consciência e capacidade cognitiva:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">3. Atividade</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia o nível de atividade física do paciente:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">4. Mobilidade</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia a capacidade de mudança de posição:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">5. Incontinência</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">Avalia o controle dos esfíncteres:</p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-lg md:text-xl">
                <FileText className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
                Pontuação e Interpretação
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-red-50 border border-red-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 mb-2 text-sm md:text-base">Alto Risco (5-9 pontos)</h4>
                ...
                <div className="bg-green-50 border border-green-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-green-800 mb-2 text-sm md:text-base">Baixo Risco (15-20 pontos)</h4>
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-lg md:text-xl">
                <Users className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
                Aplicação Prática na Enfermagem
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <p className="text-nursing-charcoal leading-relaxed mb-4 text-sm md:text-base">
          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-4 md:p-6">
              <div className="bg-gray-50 p-3 md:p-4 rounded-lg border-l-4 border-nursing-sage">
                <p className="text-nursing-charcoal leading-relaxed mb-4 text-xs md:text-sm">
                ...
                <p className="text-nursing-charcoal leading-relaxed text-xs md:text-sm">
          ...
          <Card className="border-nursing-sage/20 shadow-lg">
            ...
            <CardContent className="p-4 md:p-6">
              <ul className="space-y-2 md:space-y-3 text-nursing-charcoal">
                ...
                <li className="flex items-start gap-2">
                  <span className="w-2 h-2 bg-nursing-gold rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-xs md:text-sm">
                    Ministério da Saúde. Protocolo para Prevenção de Úlcera por Pressão. Brasília: MS, 2013.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-2 h-2 bg-nursing-gold rounded-full mt-2 flex-shrink-0"></span>
