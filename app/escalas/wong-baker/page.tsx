      ...
      <main className="flex-1 py-4 md:py-8">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-6 md:mb-8">
            ...
            <h1 className="text-2xl md:text-4xl font-bold mb-3 md:mb-4">Escala de Faces de Wong-Baker</h1>
          ...
          <Card className="mb-6 md:mb-8">
            ...
            <CardContent className="space-y-4 p-4 md:p-6">
              <div>
                <h3 className="font-semibold mb-2 text-sm md:text-base">Nome Completo:</h3>
                <p className="text-muted-foreground text-sm md:text-base">
                  Escala de Faces de Dor de Wong-Baker (FACES Pain Rating Scale) - Wong-Baker FACES Pain Rating Scale
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2 text-sm md:text-base">Finalidade e Objetivo:</h3>
          ...
          <Card className="mb-6 md:mb-8">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl">Descrição Completa da Escala</CardTitle>
            </CardHeader>
          ...
          <Card className="mb-6 md:mb-8">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl">Representação Visual da Escala</CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <div className="bg-muted/30 p-4 md:p-6 rounded-lg">
                <div className="grid grid-cols-2 md:grid-cols-6 gap-3 md:gap-4 text-center">
                  <div className="space-y-2">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-green-100 rounded-full flex items-center justify-center text-lg md:text-2xl">
                      😊
                    </div>
                    <div className="text-xs md:text-sm font-semibold">0</div>
                    <div className="text-xs text-muted-foreground">Sem dor</div>
                  </div>
                  <div className="space-y-2">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-green-50 rounded-full flex items-center justify-center text-lg md:text-2xl">
                      🙂
                    </div>
                    <div className="text-xs md:text-sm font-semibold">2</div>
                    <div className="text-xs text-muted-foreground">Dor leve</div>
                  </div>
                  <div className="space-y-2">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-yellow-50 rounded-full flex items-center justify-center text-lg md:text-2xl">
                      😐
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-orange-50 rounded-full flex items-center justify-center text-lg md:text-2xl">
                      😟
                    </div>
                    <div className="text-xs md:text-sm font-semibold">6</div>
                    <div className="text-xs text-muted-foreground">Dor intensa</div>
                  </div>
                  <div className="space-y-2">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-red-50 rounded-full flex items-center justify-center text-lg md:text-2xl">
                      😢
                    </div>
                    <div className="text-xs md:text-sm font-semibold">8</div>
                    <div className="text-xs text-muted-foreground">Dor muito intensa</div>
                  </div>
                  <div className="space-y-2">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-red-100 rounded-full flex items-center justify-center text-lg md:text-2xl">
                      😭
                    </div>
                    <div className="text-xs md:text-sm font-semibold">10</div>
          ...
          <Card className="mb-6 md:mb-8">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl">Pontuação e Interpretação</CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <div className="space-y-6">
                <div>
                  <h3 className="font-semibold mb-3 text-sm md:text-base">Pontuação Possível:</h3>
                ...
                <div>
                  <h3 className="font-semibold mb-3 text-sm md:text-base">Interpretação das Faixas de Pontuação:</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 md:p-4 bg-green-50 rounded-lg border border-green-200">
                      <div className="flex items-center gap-2 mb-2">
                        <CheckCircle className="h-4 w-4 md:h-5 md:w-5 text-green-600" />
                        <h4 className="font-semibold text-green-800 text-sm md:text-base">
                          0 - 2: Dor Leve ou Ausente
                        </h4>
                      </div>
                    ...
                    <div className="p-3 md:p-4 bg-red-50 rounded-lg border border-red-200 md:col-span-2">
                      <div className="flex items-center gap-2 mb-2">
                        <AlertCircle className="h-4 w-4 md:h-5 md:w-5 text-red-600" />
                        <h4 className="font-semibold text-red-800 text-sm md:text-base">8 - 10: Dor Intensa/Severa</h4>
                      </div>
          ...
          <Card className="mb-6 md:mb-8">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl">Aplicação Prática e Cuidados</CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2 text-sm md:text-base">Como Aplicar na Prática de Enfermagem:</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4 text-sm md:text-base">
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-sm md:text-base">Cuidados Durante a Aplicação:</h3>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 md:space-y-2 text-sm md:text-base">
          ...
          <Card className="mb-6 md:mb-8">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl">Exemplo Detalhado de Evolução de Enfermagem</CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <div className="bg-muted/30 p-4 md:p-6 rounded-lg">
          ...
          <Card className="mb-6 md:mb-8">
            <CardHeader>
              <CardTitle className="text-lg md:text-xl">Referências Oficiais</CardTitle>
            </CardHeader>
            <CardContent className="p-4 md:p-6">
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2 text-sm md:text-base">Normas e Diretrizes Oficiais:</h3>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 md:space-y-2 text-xs md:text-sm">
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-sm md:text-base">Literatura Científica:</h3>
                  <ul className="list-disc list-inside text-muted-foreground space-y-1 md:space-y-2 text-xs md:text-sm">
                    <li>
