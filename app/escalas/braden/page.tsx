      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        <div className="mb-6 md:mb-8">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-nursing-forest">Escala de Braden</h1>
              <p className="text-sm md:text-base text-nursing-forest/70">
          ...
          <div className="flex flex-wrap gap-2 mb-4 md:mb-6">
            <Badge className="bg-nursing-forest text-white text-xs md:text-sm">Risco de Úlcera por Pressão</Badge>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 md:space-y-6">
          ...
          <TabsContent value="overview" className="space-y-4 md:space-y-6">
            <Card className="border-nursing-sage/20 bg-white/60 backdrop-blur-md shadow-lg">
              <CardHeader>
                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  <div className="space-y-4 font-mono text-sm md:text-base">
                    ...
                    <div>
                      ...
                      <br />- Manutenção de umidade controlada da pele
                      <br />
                      <br />
