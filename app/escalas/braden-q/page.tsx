          ...
          <Card className="mb-6 md:mb-8 border-nursing-sage/20 shadow-lg">
            <CardHeader className="bg-nursing-sage/5">
              <CardTitle className="flex items-center gap-2 text-nursing-forest text-lg md:text-xl">
                <Baby className="h-4 w-4 md:h-5 md:w-5 text-nursing-gold" />
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">1. Mobilidade</h4>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">2. Atividade</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">Avalia o grau de atividade física:</p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">4. Umidade</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia o grau no qual a pele é exposta à umidade:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  ...
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia a exposição a forças de fricção e cisalhamento:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
                ...
                <div className="bg-nursing-mint/10 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-nursing-forest mb-2 text-sm md:text-base">6. Nutrição</h4>
                  <p className="text-nursing-charcoal mb-2 text-sm md:text-base">
                    Avalia o padrão usual de consumo alimentar:
                  </p>
                  <ul className="list-disc list-inside text-nursing-charcoal space-y-1 ml-4 text-xs md:text-sm">
                    <li>
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-red-50 border border-red-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 mb-2 text-sm md:text-base">Alto Risco (7-15 pontos)</h4>
                ...
                <div className="bg-green-50 border border-green-200 p-3 md:p-4 rounded-lg">
                  <h4 className="font-semibold text-green-800 mb-2 text-sm md:text-base">Baixo Risco (21-28 pontos)</h4>
